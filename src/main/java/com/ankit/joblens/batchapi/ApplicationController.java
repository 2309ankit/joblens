...
public class ApplicationController {
    ...
    public ApplicationController(ApplicationLifecycleService service, ApplicationQueryRepository queries) {
    ...
    public Map<String, Object> create(@RequestBody CreateApplicationRequest request) {
        ...
        long id = service.create(request.normalizedJobId(), dateOrToday(request.effectiveDate()), request.note());
    ...
    public Map<String, Object> transition(
        ...
        service.transition(id, parseStatus(request.status()), dateOrToday(request.effectiveDate()), request.note());
        return requireApplication(id);
    }
