...
public class BatchExecutionController {
    ...
    public BatchExecutionController(JobRepository jobRepository) {
    ...
    public List<JobExecutionResponse> executions() {
        ...
        for (String jobName : jobRepository.getJobNames()) {
            jobRepository.getJobInstances(jobName, 0, 100)
                    .forEach(instance -> executions.addAll(jobRepository.getJobExecutions(instance)));
        }
