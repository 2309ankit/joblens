...
import com.ankit.joblens.intelligence.ClasspathSql;
import org.springframework.jdbc.core.namedparam.MapSqlParameterSource;
import org.springframework.jdbc.core.namedparam.NamedParameterJdbcTemplate;

public class DuplicateQueryRepository {

    private static final String LIST_CLUSTERS = ClasspathSql.load("sql/duplicate-query/list-clusters.sql");
    private static final String FIND_CLUSTER = ClasspathSql.load("sql/duplicate-query/find-cluster.sql");
    ...
    public List<Map<String, Object>> findSimilarities(String decision, BigDecimal minimumScore) {
        return query(LIST_SIMILARITIES, new MapSqlParameterSource()
