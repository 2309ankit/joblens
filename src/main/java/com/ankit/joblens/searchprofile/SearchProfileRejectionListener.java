...
public class SearchProfileRejectionListener
    ...
    public SearchProfileRejectionListener(JdbcTemplate jdbcTemplate, ObjectMapper objectMapper, String inputFile) {
    ...
    public void onSkipInRead(Throwable throwable) {
        if (throwable instanceof FlatFileParseException parseException) {
            persist((long) parseException.getLineNumber(), lineAsJson(parseException.getInput()),
