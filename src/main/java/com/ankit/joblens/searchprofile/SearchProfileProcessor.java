...
public class SearchProfileProcessor implements ItemProcessor<SearchProfileCsvRow, SearchProfile> {
    ...
    private static final Set<String> SUPPORTED_EMPLOYMENT_TYPES = Set.of("ANY", "PERMANENT", "CONTRACT");
    ...
    public SearchProfile process(SearchProfileCsvRow row) {
        ...
        String employmentType = required(row.employmentType(), "employment_type is required")
