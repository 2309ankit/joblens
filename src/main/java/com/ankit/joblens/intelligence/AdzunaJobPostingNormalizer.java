...
public class AdzunaJobPostingNormalizer implements JobPostingNormalizer {
    ...
    public AdzunaJobPostingNormalizer(ObjectMapper objectMapper, HtmlTextCleaner htmlTextCleaner,
    ...
    public NormalizedJob normalize(RawJobPosting raw) {
        ...
        NormalizedJob withoutHash = new NormalizedJob(
                raw.id(),
        ...
        return new NormalizedJob(
                withoutHash.rawJobPostingId(), withoutHash.source(), withoutHash.externalJobId(),
                withoutHash.title(), withoutHash.company(), withoutHash.location(),
                withoutHash.descriptionText(), withoutHash.employmentType(), withoutHash.salaryMin(),
                withoutHash.salaryMax(), withoutHash.salaryCurrency(), withoutHash.remoteType(),
                withoutHash.postedAt(), withoutHash.sourceUrl(), contentHasher.hash(withoutHash));
    }
    ...
    private static String employmentType(JsonNode root) {
        ...
        return "part_time".equals(contractTime) || "part-time".equals(contractTime) ? "PART_TIME" : null;
    }
