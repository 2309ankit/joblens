...
public class NormalizationFailureListener implements
        ItemProcessListener<RawJobPosting, NormalizedJob>,
    ...
    public void onSkipInProcess(RawJobPosting item, Throwable throwable) {
        String reason = throwable.getMessage() == null ? "Normalization rejected" : throwable.getMessage();
