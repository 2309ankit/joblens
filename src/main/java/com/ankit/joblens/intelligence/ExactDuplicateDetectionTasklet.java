...
public class ExactDuplicateDetectionTasklet implements Tasklet {
  ...
  public ExactDuplicateDetectionTasklet(
      DuplicateDetectionRepository repository, boolean failThisExecution) {
  ...
  public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) {
    ...
    List<List<DuplicateJobView>> duplicateGroups =
  ...
  private static void unionWithFirst(
      Map<Long, Long> parent, Map<String, Long> firstByValue, String value, long jobId) {
