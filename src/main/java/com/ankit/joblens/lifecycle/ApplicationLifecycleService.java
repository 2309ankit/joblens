...
public class ApplicationLifecycleService {
    ...
    public ApplicationLifecycleService(ApplicationLifecycleRepository repository,
    ...
    public long create(long normalizedJobId, LocalDate effectiveDate, String note) {
        ...
        long applicationId = repository.createApplication(
                normalizedJobId, candidateProfileId, effectiveDate, normalizeNote(note));
        repository.insertHistory(applicationId, null, ApplicationStatus.SAVED,
                effectiveDate, normalizeNote(note));
        return applicationId;
    }

    @Transactional
    public void transition(long applicationId, ApplicationStatus target,
        ...
        repository.insertHistory(applicationId, application.status(), target,
                effectiveDate, normalizeNote(note));
    }
