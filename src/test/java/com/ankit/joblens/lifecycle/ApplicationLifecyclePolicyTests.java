...
class ApplicationLifecyclePolicyTests {
  ...
  void permitsForwardProgressAndTerminalExits() {
    ...
    assertThat(policy.canTransition(ApplicationStatus.APPLIED, ApplicationStatus.INTERVIEW))
        .isTrue();
    ...
    assertThat(policy.canTransition(ApplicationStatus.SCREENING, ApplicationStatus.REJECTED))
        .isTrue();
  }
  ...
  void rejectsBackwardSameAndTerminalTransitions() {
    ...
    assertThat(policy.canTransition(ApplicationStatus.APPLIED, ApplicationStatus.APPLIED))
        .isFalse();
    assertThat(policy.canTransition(ApplicationStatus.ACCEPTED, ApplicationStatus.WITHDRAWN))
        .isFalse();
