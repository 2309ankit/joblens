...
const defaults = { primaryLocation: '', keywords: '', maxPages: 3, employmentPreference: 'PERMANENT', workPreference: 'REMOTE,HYBRID,ONSITE', excludeMyCareersFuture: false, salaryMin: '', salaryMax: '' };
